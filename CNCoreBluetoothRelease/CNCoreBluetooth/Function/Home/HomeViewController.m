...
- (void)viewDidLoad {
    ...
    __weak ScanAlertView *weakAlert = _alert;
...
- (void)thumbPrint:(CBPeripheral *)peri{
    ...
    if (kDevice_Is_iPhoneX) {
        result = @"Validate the face ID";
    }else{
        result = @"Validate the touch ID";
    }
    ...
    else
    {
        ...
        switch (error.code) {
            ...
            {
                if (kDevice_Is_iPhoneX) {
                    [CNPromptView showStatusWithString:@"FaceID is not enrolled"];
                }else{
            ...
            {
                if (kDevice_Is_iPhoneX) {
                    [CNPromptView showStatusWithString:@"FaceID not available"];
                }else{
